...
import "../JuegoNumManoVideo/num_05";
import '../../styles/num5.css'
// import { drawRect } from "./draw_num_3";

// --- arrelgar css de juego porque sale desconfigurado
  ...
  if (start) {
    return (
      <div className="Num5">
        ...
        />
        <img className="img_ejemplo" src={require("../../assets/Vimagenes/SignosNumeros/NumbersManos/" + referencia + ".png")}></img>
        <img className="numejemplo" src={require("../../assets/Vimagenes/SignosNumeros/Numbers/" + referencia + ".png")}></img>        
